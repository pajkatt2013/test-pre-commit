...
if [[ "$env_argument" = "dev" ]];
then
    api_endpoint='https://raas-dev.api.aws.orionadp.com/v1/jobs'
elif [[ "$env_argument" = "int" ]];
then
    api_endpoint='https://raas-int.api.aws.orionadp.com/v1/jobs'
elif [[ "$env_argument" = "prod" ]];
then
    api_endpoint='https://raas.api.aws.orionadp.com/v1/jobs'
fi
